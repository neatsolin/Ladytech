...
<head>
    ...
    <title>Shop - Snacks Products</title>
            ...
            <div class="col-md-3">
                ...
                <div class="filter-categories mt-4">
                    ...
                    <ul class="list-group">
                        ...
                        $selected_category = isset($_GET['category']) ? (int)$_GET['category'] : 4; // Default to Snacks (4)
                    ...
                    foreach ($dbProducts as $product) {
                        ...
                        if ($category_id === $selected_category) {
                            ...
                            if (empty($search_query) || stripos(strtolower($product['productname']), $search_query) !== false) {
                                ...
                                $description = isset($product['description']) && !empty($product['description']) 
                                    ? htmlspecialchars($product['description']) 
                                    : 'No description available'; // Ensure description is caught safely
                                $filtered_products[] = [
                                    'id' => $product['id'],
                                ...
                                <div class="card text-start shadow-sm d-flex flex-column" style="border-radius: 12px; overflow: hidden; height: 100%;">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="rating mb-2">
                                            ...
                                            <span class="star" data-star="5" onclick="setRating(<?php echo $router['id']; ?>, 5)">★</span>
