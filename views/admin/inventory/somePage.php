...
<body>
    ...
    <div class="text-white text-center" style="background-image: url('https://media.makrocambodiaclick.com/PRODUCT_1725470858968.jpeg'); background-size: cover; background-position: center; height: 70vh; margin-bottom: 0;">
