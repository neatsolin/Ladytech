...
<body>
    ...
    <script>
        ...
        const productsByCategory = {
            1: [
                { id: 1, imgs: ["imges/Sofy Cooling fresh.png", "imges/Sofy Cooling fresh.png"], alt: "Water 1", title: "Water ", creator: "Creator A", price: "2.5" },
                { id: 2, imgs: ["views/assets/about-images/Eau Kulen big.png", "views/assets/about-images/Knorr.png"], alt: "Water ", title: "Water ", creator: "Creator A", price: "3.0" },
                { id: 3, imgs: ["views/assets/about-images/Eau Kulen big.png", "views/assets/about-images/Mouly.png"], alt: "Water ", title: "Water ", creator: "Creator A", price: "2.8" }
            ],
            2: [
                { id: 1, imgs: ["views/assets/about-images/ACNES.png", "views/assets/about-images/Keepo pink.png"], alt: "Beverage ", title: "Beverage ", creator: "Creator B", price: "1.8" },
                { id: 2, imgs: ["views/assets/about-images/ACNES.png", "views/assets/about-images/Mama tom yum.png"], alt: "Beverage ", title: "Beverage ", creator: "Creator B", price: "1.9" },
                { id: 3, imgs: ["views/assets/about-images/ACNES.png", "views/assets/about-images/Pao Pink Detergent.png"], alt: "Beverage ", title: "Beverage ", creator: "Creator B", price: "2.0" }
            ],
            3: [
                { id: 1, imgs: ["views/assets/about-images/Keepo pink.png", "views/assets/about-images/Eau Kulen big.png"], alt: "Tissue ", title: "Tissue ", creator: "Creator C", price: "3.5" },
                { id: 2, imgs: ["views/assets/about-images/Keepo pink.png", "views/assets/about-images/Knorr.png"], alt: "Tissue ", title: "Tissue ", creator: "Creator C", price: "3.6" },
                { id: 3, imgs: ["views/assets/about-images/Keepo pink.png", "views/assets/about-images/Mouly.png"], alt: "Tissue ", title: "Tissue ", creator: "Creator C", price: "3.7" }
            ],
            4: [
                { id: 1, imgs: ["views/assets/about-images/Knorr.png", "views/assets/about-images/ACNES.png"], alt: "Snack ", title: "Snack ", creator: "Creator D", price: "2.2" },
                { id: 2, imgs: ["views/assets/about-images/Knorr.png", "views/assets/about-images/Keepo pink.png"], alt: "Snack ", title: "Snack ", creator: "Creator D", price: "2.3" },
                { id: 3, imgs: ["views/assets/about-images/Knorr.png", "views/assets/about-images/Mama tom yum.png"], alt: "Snack ", title: "Snack ", creator: "Creator D", price: "2.4" }
            ],
            5: [
                { id: 1, imgs: ["views/assets/about-images/Ring Floor.png", "views/assets/about-images/Eau Kulen big.png"], alt: "Ingredient ", title: "Ingredient ", creator: "Creator E", price: "4.0" },
                { id: 2, imgs: ["views/assets/about-images/Ring Floor.png", "views/assets/about-images/Mouly.png"], alt: "Ingredient ", title: "Ingredient", creator: "Creator E", price: "4.1" },
                { id: 3, imgs: ["views/assets/about-images/Ring Floor.png", "views/assets/about-images/Muyly toothbrush.png"], alt: "Ingredient", title: "Ingredient Item 3", creator: "Creator E", price: "4.2" }
            ],
            6: [
                { id: 1, imgs: ["views/assets/about-images/Mama tom yum.png", "views/assets/about-images/ACNES.png"], alt: "Hygiene ", title: "Hygiene ", creator: "Creator F", price: "1.5" },
                { id: 2, imgs: ["views/assets/about-images/Mama tom yum.png", "views/assets/about-images/Keepo pink.png"], alt: "Hygiene ", title: "Hygiene ", creator: "Creator F", price: "1.6" },
                { id: 3, imgs: ["views/assets/about-images/Mama tom yum.png", "views/assets/about-images/Pao Pink Detergent.png"], alt: "Hygiene ", title: "Hygiene ", creator: "Creator F", price: "1.7" }
            ],
            7: [
                { id: 1, imgs: ["views/assets/about-images/Pao Pink Detergent.png", "views/assets/about-images/Eau Kulen big.png"], alt: "Oral ", title: "Oral ", creator: "Creator G", price: "3.0" },
                { id: 2, imgs: ["views/assets/about-images/Pao Pink Detergent.png", "views/assets/about-images/Knorr.png"], alt: "Oral ", title: "Oral", creator: "Creator G", price: "3.1" },
                { id: 3, imgs: ["views/assets/about-images/Pao Pink Detergent.png", "views/assets/about-images/Mouly.png"], alt: "Oral ", title: "Oral ", creator: "Creator G", price: "3.2" }
            ],
            8: [
                { id: 1, imgs: ["views/assets/about-images/Mouly.png", "views/assets/about-images/ACNES.png"], alt: "Feminine ", title: "Feminine", creator: "Creator H", price: "4.5" },
                { id: 2, imgs: ["views/assets/about-images/Mouly.png", "views/assets/about-images/Keepo pink.png"], alt: "Feminine ", title: "Feminine ", creator: "Creator H", price: "4.6" },
                { id: 3, imgs: ["views/assets/about-images/Mouly.png", "views/assets/about-images/Mama tom yum.png"], alt: "Feminine ", title: "Feminine ", creator: "Creator H", price: "4.7" }
            ],
            9: [
                { id: 1, imgs: ["views/assets/about-images/Muyly toothbrush.png", "views/assets/about-images/Eau Kulen big.png"], alt: "Soap ", title: "Soap ", creator: "Creator I", price: "1.0" },
                { id: 2, imgs: ["views/assets/about-images/Muyly toothbrush.png", "views/assets/about-images/Knorr.png"], alt: "Soap ", title: "Soap ", creator: "Creator I", price: "1.1" },
                { id: 3, imgs: ["views/assets/about-images/Muyly toothbrush.png", "views/assets/about-images/Mouly.png"], alt: "Soap ", title: "Soap ", creator: "Creator I", price: "1.2" }
            ]
        };
                                ...
                                <?php if (isset($_SESSION['user_id'])): ?>
                                    <div class="dropdown position-absolute top-0 end-0 m-2">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li><a class="dropdown-item text-danger" href="#" onclick="deleteCard('${product.id}-${categoryId}')">Delete</a></li>
                                        </ul>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if (isset($_SESSION['user_id'])): ?>
                                    <div class="dropdown position-absolute top-0 end-0 m-2">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li><a class="dropdown-item text-danger" href="#" onclick="deleteCard('${newId}-${categoryId}')">Delete</a></li>
                                        </ul>
                                    </div>
                                <?php endif; ?>
        ...
        // Initialize with "Beverages" as active
        window.onload = () => {
            setActiveCategory(2);
        };
    </script>
