...
CREATE TABLE `admin` (
  ...
  `topproducts` text DEFAULT NULL,
  `slowproducts` text DEFAULT NULL,
  `weeklyreport` text DEFAULT NULL
...
CREATE TABLE `orders` (
  ...
  `orderstatus` enum('Pending','Dilivered','Canceled') NOT NULL DEFAULT 'Pending',
  `payments` enum('KH Riel','USD') NOT NULL,
...
CREATE TABLE `products` (
  ...
  `categories` enum('Drinking Water','Tissue','Feminine Hygiene','House Hold Hygiene','Oral Health','Beverages','Soap','Cooking Ingredients','Snacks') NOT NULL,
